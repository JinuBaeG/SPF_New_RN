...
const ADD_REQUST_TUTOR_MUTATION = gql`
  mutation requestAddTutor($title: String!, $discription: String!) {
    requestAddTutor(title: $title, discription: $discription) {
      ok
      error
    }
  }
...
export default function RequestAddTutor({ navigation, route }: any) {
  ...
  const [requestAddTutorMutation, { loading }] = useMutation(
    ADD_REQUST_TUTOR_MUTATION,
    {
      onCompleted,
    }
  );
